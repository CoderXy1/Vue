...
import { Calendar,Tag,Rate,RadioGroup, Radio,Stepper,FloatingBubble,Popover } from 'vant';
...
app.use(Calendar).use(Tag).use(Rate).use(RadioGroup).use(Radio).use(Stepper).use(FloatingBubble).use(Popover);
